...
# Convert the problem into the following problem:
# Let arr = nums * 2
# The problems becomes calculate the maximum continuous subarray with the length in the range of [1, n]
class Solution:
    # Example:
    # a = 2, b = 4
    ...
    def maxSubarraySumCircular(self, nums: List[int]) -> int:
        return self.max_subarray_sum_with_len_range(nums * 2, 1, len(nums))
